...
public class Dns1State implements State {
    ...
    public static class Dns1Fragment extends WifiConnectivityGuidedStepFragment {
        ...
        public GuidedActionsStylist onCreateActionsStylist() {
            return new GuidedActionsStylist() {
                ...
                public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                    ...
                    return new Dns1ViewHolder(v);
                }
                @Override
                public void onBindViewHolder(ViewHolder vh, GuidedAction action) {
                     super.onBindViewHolder(vh, action);
                     if (action.getId() == GuidedAction.ACTION_ID_CONTINUE) {
                        Dns1ViewHolder viewHolder = (Dns1ViewHolder) vh;
        ...
        private static class Dns1ViewHolder extends GuidedActionsAlignUtil.SetupViewHolder {

            Dns1ViewHolder(View v) {
               super(v);
            }
        }
    }
