...
public class HdmiCecFragment extends LeanbackPreferenceFragment {
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        switch (key) {
            case KEY_CEC_SWITCH:
                writeCecOption(Settings.Global.HDMI_CONTROL_ENABLED,
                        mCecSwitchPref.isChecked());
                boolean hdmiControlEnabled = readCecOption(
            ...
            case KEY_CEC_ONEKEY_PLAY:
                writeCecOption(HdmiCecManager.HDMI_CONTROL_ONE_TOUCH_PLAY_ENABLED,
                        mCecOnekeyPlayPref.isChecked());
                return true;
            case KEY_CEC_ONEKEY_POWEROFF:
                writeCecOption(Settings.Global.HDMI_CONTROL_AUTO_DEVICE_OFF_ENABLED,
                        mCecOnekeyPoweroffPref.isChecked());
                return true;
    ...
    private void refresh() {
        ...
        mCecOnekeyPlayPref.setChecked(readCecOption(
                HdmiCecManager.HDMI_CONTROL_ONE_TOUCH_PLAY_ENABLED));
        mCecOnekeyPlayPref.setEnabled(hdmiControlEnabled);
        mCecOnekeyPoweroffPref.setChecked(readCecOption(
                Settings.Global.HDMI_CONTROL_AUTO_DEVICE_OFF_ENABLED));
        mCecOnekeyPoweroffPref.setEnabled(hdmiControlEnabled);
        mCecAutoChangeLanguagePref.setChecked(readCecOption(
